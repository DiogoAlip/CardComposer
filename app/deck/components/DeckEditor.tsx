  ...
  return (
    <div className="flex h-screen">
      {barIcon && (
        <Menu
          onClick={closeBar}
          className="w-6 h-6 text-primary absolute top-4 left-4"
        />
      )}
      ...
      <div
        ...
        className={`overflow-auto custom-scrollbar absolute lg:relative border-r border-border bg-black/85 p-4 h-full ${barIcon ? "hidden" : ""}`}
      >
